...
const Country = ({ ...props }: ICountry) => {
  return (
    <div className="rounded-md grid grid-cols-4 gap-4 items-center text-blue-900 text-xs xs:text-base md:text-lg xl:grid-cols-5 hover:bg-blue-300 dark:hover:bg-medium-gray hover:cursor-pointer dark:text-offwhite">
